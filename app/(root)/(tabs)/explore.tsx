...
const Explore = () => {
  ...
  useEffect(() => {
    // Alert.alert("Alert", `Refetching with params:  ${params.filter}, ${params.query!}`);
    refetch({
      filter: params.filter!,
      query: params.query!,
      limit: 10
        ...
        ListHeaderComponent={
          <View className="px-5">
            ...
            <View className="flex flex-row items-center justify-between mt-5">
              <TouchableOpacity onPress={() => router.back()} className="flex flex-row bg-primary-200 rounded-full
               items-center size-11 justify-center">
